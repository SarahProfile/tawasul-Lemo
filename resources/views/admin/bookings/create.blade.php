            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('dropoff_location') is-invalid @enderror" id="dropoff_location" name="dropoff_location" value="{{ old('dropoff_location') }}" required>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" step="any" class="form-control @error('pickup_lat') is-invalid @enderror" id="pickup_lat" name="pickup_lat" value="{{ old('pickup_lat') }}">
                        @error('pickup_lat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" step="any" class="form-control @error('pickup_lng') is-invalid @enderror" id="pickup_lng" name="pickup_lng" value="{{ old('pickup_lng') }}">
                        @error('pickup_lng')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" step="any" class="form-control @error('dropoff_lat') is-invalid @enderror" id="dropoff_lat" name="dropoff_lat" value="{{ old('dropoff_lat') }}">
                        @error('dropoff_lat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" step="any" class="form-control @error('dropoff_lng') is-invalid @enderror" id="dropoff_lng" name="dropoff_lng" value="{{ old('dropoff_lng') }}">
                        @error('dropoff_lng')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
